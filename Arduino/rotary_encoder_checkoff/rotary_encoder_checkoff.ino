...
void setup(){
	...
	encoder2.clearCount();
	String startMessage = "Encoder Start = " + String((int32_t)encoder.getCount());
...
void loop(){
	// Store encoder counts in variables
	int32_t encoder1Count = encoder.getCount();
	int32_t encoder2Count = encoder2.getCount();
	String encoderMessage = "Encoder count = " + String(encoder1Count) + " " + String(encoder2Count);
